#ifndef TDLambdaNStepAgent_H
#define TDLambdaNStepAgent_H
...
class TDLambdaNStepAgent : public Agent{
 ...
 public:
  ...
  TDLambdaNStepAgent(const int &numFeatures, const int &numActions, const unsigned long int &totalEpisodes, const double &initWeight, const double &lambda, const double &alphaInit, const double &epsInit, const int &randomSeed, const int &persStepSize);
  ~TDLambdaNStepAgent();
